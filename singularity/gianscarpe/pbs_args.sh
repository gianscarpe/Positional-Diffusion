...
cd /home/gscarpellini/PuzzleDiffusion-GNN
# Run the program.
...
singularity run --nv -B ./:/app -B /work/gscarpellini:/work/gscarpellini singularity/build/diffPYG.sif bash /app/singularity/gianscarpe/run_Script_args.sh $pyfile "$args" #$1
